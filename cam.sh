...
# Modifying my script doesn't make you a programmer, bru, it just makes you a script kiddie.
 ...
 ${BLUE}        █▄▄ █▀█ █░▀░█   ░░   ▀▄▀ █ █▀▄ █▄█ ▄█ 
          ...
          ${RED}     ==========================================      
           ${GREEN}[${WHITE}-${GREEN}]${CYAN}Tool Created by the developer${WHITE}${RED} (Version : 1.0) 
         EOF 
 } 
 ...
 about() { 
         { clear; banner; echo; } 
         cat <<- EOF 
                 ${GREEN}Author   ${RED}:  ${ORANGE} the ${RED}[ ${ORANGE} developer ${RED}] 
                 ${GREEN}Github   ${RED}:  ${CYAN}https://github.com/thedeveloper03 
